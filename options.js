...
const autoHighlightEl=document.getElementById("auto-highlight");
const autoHighlightDomainsEl=document.getElementById("auto-highlight-domains");
const autoHighlightIpsEl=document.getElementById("auto-highlight-ips");
const autoHighlightHashesEl=document.getElementById("auto-highlight-hashes");
const autoHighlightCVEsEl=document.getElementById("auto-highlight-cves");
...
function load(){
  chrome.storage.local.get([
    ...
    autoHighlightDomainsEl.checked = res.autoHighlightDomains !== false;
    autoHighlightIpsEl.checked = res.autoHighlightIPs !== false;
    autoHighlightHashesEl.checked = res.autoHighlightHashes !== false;
    autoHighlightCVEsEl.checked = res.autoHighlightCVEs !== false;
    syncAutoHighlightUI();
...
function syncAutoHighlightUI(){
  const on = !!autoHighlightEl.checked;
  autoHighlightDomainsEl.disabled = !on;
  autoHighlightIpsEl.disabled = !on;
  autoHighlightHashesEl.disabled = !on;
  autoHighlightCVEsEl.disabled = !on;
}

autoHighlightEl.addEventListener("change", syncAutoHighlightUI);
...
document.getElementById("save-all").onclick=()=>{
  ...
  const autoHighlightEnabled = !!autoHighlightEl.checked;
  const autoHighlightDomains = !!autoHighlightDomainsEl.checked;
  const autoHighlightIPs = !!autoHighlightIpsEl.checked;
  const autoHighlightHashes = !!autoHighlightHashesEl.checked;
  const autoHighlightCVEs = !!autoHighlightCVEsEl.checked;
